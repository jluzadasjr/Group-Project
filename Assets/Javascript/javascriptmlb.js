$(document).ready(function() {
    ...
    $.ajax({
      type: "GET",
      url:
        "https://cors-anywhere.herokuapp.com/https://api.mysportsfeeds.com/v1.1/pull/mlb/2018-2019-regular/daily_game_schedule.json?fordate=" +
        today,
      dataType: "json",
      async: true,
      headers: {
    ...
    $.ajax({
      type: "GET",
      url:
        "https://cors-anywhere.herokuapp.com/https://api.mysportsfeeds.com/v1.1/pull/mlb/2018-2019-regular/scoreboard.json?fordate=" +
        yesterday,
      dataType: "json",
      async: true,
      headers: {
